...
title: Deductibles, Coinsurance and Limits
slug: deductibles-coinsurance-and-limits
blueprint: GK.II
summary: The arithmetic questions — and the coinsurance formula that catches people who insure for too little.
estimated_minutes: 16
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# The three numbers that decide what a claim pays
...
4. **No.** Once the fraction reaches 1 the loss is paid in full less the
   deductible. Insurance never pays more than the loss.
