...
slug: surplus-lines
blueprint: TX.II
summary: Placing business with an insurer Texas has not authorised — the diligent effort, the separate licence, and the warning that must appear on the document.
estimated_minutes: 16
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# Buying from an insurer the state has not licensed
