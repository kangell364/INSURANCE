...
title: Unfair and Prohibited Trade Practices
slug: unfair-and-prohibited-trade-practices
blueprint: TX.I
summary: Chapter 541's list of prohibited acts, the private right of action with treble damages, and the one defendant it does not reach.
estimated_minutes: 16
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# The chapter a producer is disciplined under
...
7. **No.** §541.060(a)(9) permits it only on a court order, for a fire loss,
   or where the claim involves lost profits or income.
