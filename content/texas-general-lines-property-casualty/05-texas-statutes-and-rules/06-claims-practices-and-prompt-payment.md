...
title: Claims Practices and Prompt Payment
slug: claims-practices-and-prompt-payment
blueprint: TX.II
summary: Chapter 542's deadlines — and the 18% penalty that is no longer 18% in every case.
estimated_minutes: 15
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# The clocks on a Texas claim
...
6. **No.** Subchapter B applies to **first-party** claims. A third party
   claiming against the insured is outside it.
