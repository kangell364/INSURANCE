...
slug: texas-workers-compensation
blueprint: TX.II
summary: The one state where coverage is optional — what a non-subscriber gives up, what it keeps, and the benefit formulas.
estimated_minutes: 16
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# The state that made it elective
...
8. The **lesser of the actual reasonable burial expenses or $10,000**
   ...
   died away from their usual place of employment.
