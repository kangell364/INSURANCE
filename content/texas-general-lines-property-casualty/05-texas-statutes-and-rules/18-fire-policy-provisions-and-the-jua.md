...
title: Fire Policy Provisions and the Medical Liability JUA
slug: fire-policy-provisions-and-the-jua
blueprint: TX.II
summary: The rule that turns a total fire loss into the full policy limit, and the fourth Texas residual market.
estimated_minutes: 12
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# Two provisions the blueprint names that fit nowhere else
...
7. **No.** §2203.005 says the association is **not an authorized insurer for
   ...
   not satisfy or obstruct the diligent effort requirement.
