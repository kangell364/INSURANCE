...
title: Windstorm and the FAIR Plan
slug: windstorm-and-the-fair-plan
blueprint: TX.II
summary: Texas's two residual property markets — who each one covers, the declination counts, and the limits.
estimated_minutes: 16
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# Two markets of last resort, and the line between them
