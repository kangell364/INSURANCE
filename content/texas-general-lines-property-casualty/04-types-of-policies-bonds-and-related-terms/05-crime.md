...
slug: crime
blueprint: GK.IV
summary: Five crimes the exam insists you distinguish, and the coverage that answers the one that costs most.
estimated_minutes: 13
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# Words that mean the same thing in conversation and different things here
