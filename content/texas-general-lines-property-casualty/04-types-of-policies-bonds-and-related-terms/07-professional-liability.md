...
blueprint: GK.IV
summary: The coverages that answer for advice, expertise and decisions — all excluded from the CGL.
estimated_minutes: 15
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# When the injury is caused by judgement, not by an accident
