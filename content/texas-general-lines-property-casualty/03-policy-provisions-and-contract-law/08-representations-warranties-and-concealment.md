...
title: Representations, Warranties and Concealment
slug: representations-warranties-and-concealment
blueprint: GK.III
summary: Four ways an insured can say something wrong, and only some of them cost the policy.
estimated_minutes: 13
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# Saying, not saying, and promising
