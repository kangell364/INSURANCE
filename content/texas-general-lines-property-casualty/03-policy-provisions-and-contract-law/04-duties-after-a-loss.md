...
slug: duties-after-a-loss
blueprint: GK.III
summary: What the insured must do, what the insurer must do, and the difference between notice of claim and proof of loss.
estimated_minutes: 14
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# The obligations that survive the loss
...
6. **$28,000**, the actual cash value. The replacement cost holdback is
   payable only once the property is actually repaired or replaced.
