...
title: The Declarations Page
slug: the-declarations-page
blueprint: GK.III
summary: What a policy is made of, and why the first page is the one that answers most questions.
estimated_minutes: 14
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# The page that identifies this policy from every other one
