...
slug: who-is-an-insured
blueprint: GK.III
summary: Named insured, first named insured, additional insured, mortgagee — four different things the exam refuses to let you blur.
estimated_minutes: 14
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# Four kinds of people with rights under one policy
...
5. **The car owner's.** Auto liability follows the car, and a permissive user
   is an insured under the owner's policy.
