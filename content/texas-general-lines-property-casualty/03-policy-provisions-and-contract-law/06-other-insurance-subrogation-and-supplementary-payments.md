---
module: Policy Provisions and Contract Law
title: Other Insurance, Subrogation and Supplementary Payments
slug: other-insurance-subrogation-and-supplementary-payments
blueprint: GK.VI
summary: How two policies covering one loss divide it, how the insurer recovers from whoever caused it, and what a liability policy pays on top of the limit.
estimated_minutes: 15
status: draft
review: UNREVIEWED — drafted by Claude, not yet checked by a licensed producer
---

# Three conditions that all protect the same principle
...
5. The insured is generally made whole first, so the **$1,000 deductible**
   comes back to the insured and the insurer keeps **$5,000**.
