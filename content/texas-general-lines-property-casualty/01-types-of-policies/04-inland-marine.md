...
slug: inland-marine
blueprint: GK.I
summary: Coverage for property that moves, property that is unusually valuable, and property no standard form handles well.
...
5. **Accounts receivable** coverage — the uncollectible sums, the cost of
   reconstructing the records, and the extra collection expense.
